...
2. Installing the method2 Package

A. Change to the directory that contains the file setup.py and the subdirectory method2. 
...
3. Using the method2 Package

The method2 package is on your Python path. To import it into a Python script or session, 
execute:
