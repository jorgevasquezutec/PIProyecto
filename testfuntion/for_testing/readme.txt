testfuntion MATLAB Python Package
...
2. Installing the testfuntion Package

A. Change to the directory that contains the file setup.py and the subdirectory 
testfuntion. If you do not have write permissions, copy all its contents to a temporary 
...
3. Using the testfuntion Package

The testfuntion package is on your Python path. To import it into a Python script or 
session, execute:
